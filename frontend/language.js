...
const languages = {
	en: {
		...
		lang_feature_desc_build_unit: 'build units automaticaly',
	...
	de: {
		...
		lang_navbar_links: 'links',
		lang_navbar_landing_page: 'homepage',
		lang_navbar_github: 'github',
		lang_navbar_report_bug: 'melde einen fehler',
		lang_navbar_releases: 'versionen',
		lang_navbar_felixbreuer: 'felixbreuer',
		lang_navbar_donate: 'spenden',
	...
	sk: {
		lang_navbar_king_bot_api: 'king-bot-api',
		lang_navbar_home: 'domov',
		lang_navbar_add_feature: 'pridať funkciu',
		lang_navbar_extras: 'doplnky',
		lang_navbar_easy_scout: 'jednoduché špehovanie',
		lang_navbar_inactive_finder: 'hľadač neaktívnych',
		lang_navbar_logger: 'logger',
		lang_navbar_change_login: 'zmeniť login',
		lang_navbar_language: 'jazyk',
		lang_navbar_links: 'linky',
		lang_navbar_landing_page: 'vstupná stránka',
		lang_navbar_github: 'github',
		lang_navbar_report_bug: 'nahlásiť chybu',
		lang_navbar_releases: 'vydania',
		lang_navbar_felixbreuer: 'felixbreuer',
		lang_navbar_donate: 'podporiť',

		lang_feature_finish_earlier: 'okamžité dokončenie',
		lang_feature_hero: 'automatické dobrodružstvá',
		lang_feature_farming: 'poslať farmlist',
		...
		lang_feature_desc_raise_fields: 'táto funkcia bude postupne zvyšovať políčka na zadaný level. Najprv zvýši level tomu políčku, ktoré má najmenej surovín.',
		lang_feature_desc_farming: 'táto funkcia bude intervalovo posielať farmlist.',
		lang_feature_desc_trade_route: 'pošle obchodníkov, v intervaloch, z počiatočnej dediny do cieľovej dediny.',

		lang_home_features: 'tvoje funkcie',
		lang_home_name: 'názov funkcie',
		lang_home_description: 'popis',
		lang_home_status: 'status',
		lang_home_off_on: 'off / on',
		lang_home_options: 'možnosti',

		lang_easy_scout_title: 'jednoduché špehovanie',
		lang_easy_scout_description: 'poslať 1 špeha do každej dediny z vybratého farmlistu',
		lang_easy_scout_amount: 'počet',

		lang_combo_box_select_farmlist: 'vybrať farmlist',
		lang_combo_box_select_village: 'vybrať dedinu',

		lang_label_spy_for: 'vyšpehovať',
		lang_label_ressources: 'suroviny',
		lang_label_defence: 'obranné budovy a jednotky',

		lang_table_farmlist: 'farmlist',
		lang_table_village: 'dedina',
		lang_table_remove: 'vymazať',

		lang_table_distance: 'vzdialenosť',
		lang_table_population: 'populácia',
		lang_table_coordinates: 'súradnice',
		lang_table_player: 'hráč',
		lang_table_kingdom: 'kráľovstvo',
		lang_table_tribe: 'národ',
		lang_table_id: 'id',
		lang_table_name: 'meno',
		lang_table_lvl: 'lvl',
		lang_table_pos: 'pos',

		lang_button_submit: 'odoslať',
		lang_button_cancel: 'zrušiť',
		lang_button_delete: 'zmazať',
		lang_button_search: 'hľadať',

		lang_adventure_adventure_type: 'typ dobrodružstva',
		lang_adventure_short: 'krátke',
		lang_adventure_long: 'dlhé',
		lang_adventure_min_health: 'minimálny život',
		lang_adventure_max: 'max',
		lang_adventure_health: 'život',

		lang_queue_res_fields: 'surovinové polia',
		lang_queue_buildings: 'budovy',
		lang_queue_queue: 'fronta',
		lang_queue_level: 'level',
		lang_queue_wood: 'drevo',
		lang_queue_clay: 'hlina',
		lang_queue_iron: 'železo',
		lang_queue_crop: 'obilie',

		lang_farmlist_add: 'pridať farmlist',
		lang_farmlist_interval: 'interval v sekundách (min / max)',
		lang_farmlist_losses: 'farmy so stratami presunúť do',

		lang_finder_default: 'predvolené',
		lang_finder_name: 'hľadač neaktívnych',
		lang_finder_distance_to: 'relativná vzdialenosť k',
		lang_finder_player_pop: 'populácia hráča (min / max)',
		lang_finder_village_pop: 'populácia dediny (min / max)',
		lang_finder_distance: 'vzdialenosť (min / max)',
		lang_finder_add_list: 'pridať do farmlistu',
		lang_finder_inactive_for: 'neaktívny (dní)',
		lang_finder_days: 'dni',
		lang_finder_description: 'hľadá neaktívnych hráčov a zobrazuje ich dediny na základe vzdialenosti. Po pridaní do farmlistu je možné tieto dediny špehnúť pomocou jednoduchého špehovania.',

		lang_log_level: 'level',
		lang_log_group: 'skupina',
		lang_log_message: 'správa',

		lang_login_notification: 'bot sa vypína.... pre prejavenie zmien, reštartuj ho.',
		lang_login_reset_features: 'toto resetne všetky nakonfigurované funkcie!',
		lang_login_login: 'login',
		lang_login_gameworld: 'svet',
		lang_login_email: 'email',
		lang_login_password: 'heslo',
		lang_login_sitter_dual: 'zástupca / dual ?',
		lang_login_optional: '(dobrovoľné)',
		lang_login_sitter_description: 'ak si zástupca alebo dual, je potrebné uviesť meno pre korektnú identifikáciu sveta',
		lang_login_ingame_name: 'herné meno (iba ak si zástupca alebo dual)',

		lang_trade_source_village: 'vybrať zdrojovú dedinu',
		lang_trade_dest_village: 'vybrať cieľovú dedinu',
		lang_trade_interval: 'interval v sekundách (min / max)',
		lang_trade_send_ress: 'poslať (drevo|hlina|železo|obilie)',
		lang_trade_source_greater: 'ak zdroj má viac ako (drevo|hlina|železo|obilie)',
		lang_trade_dest_less: 'a cieľ má menej ako (drevo|hlina|železo|obilie)',

		lang_common_min: 'min',
		lang_common_max: 'max',
		lang_common_prov_number: 'zadaj číslo',
	}
};
